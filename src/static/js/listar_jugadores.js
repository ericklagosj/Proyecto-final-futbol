...
pdfBtn.addEventListener("click", () => {
  const tableData = customers_table.innerHTML;
  downloadFile(tableData, "pdf", "ListaDeJugadores");
});

jsonBtn.addEventListener("click", () => {
  const json = toJSON(customers_table);
  downloadFile(json, "json", "ListaDeJugadores");
});

csvBtn.addEventListener("click", () => {
  const csv = toCSV(customers_table);
  downloadFile(csv, "csv", "ListaDeJugadores");
});

excelBtn.addEventListener("click", () => {
  const excel = toExcel(customers_table);
  downloadFile(excel, "excel", "ListaDeJugadores");
});